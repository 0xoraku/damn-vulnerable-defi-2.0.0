...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        ...
        const HackSideEntranceFactory = await ethers.getContractFactory('HackSideEntrance', attacker);
        const hackSideEntrance = await HackSideEntranceFactory.deploy(this.pool.address);
        await hackSideEntrance.connect(attacker).attack();
    });
